...
| [DECISIONS.md](./DECISIONS.md) | Contributors | Architecture decision log |

## External links

- **Repository:** https://github.com/nazkari86-lab/GlacierNET-KZ
- **Live demo:** https://huggingface.co/spaces/dulatnurlanuly/codedepo-v2
- **API docs (local):** http://localhost:8080/docs after `./scripts/start.sh`
