...
> Этот файл включает исторические и демонстрационные функции. Числа старого
> тренда и прогноз до 2050 нельзя трактовать как текущий научный вывод.
> Источник истины: [REPRODUCIBILITY.md](./REPRODUCIBILITY.md) и `benchmarks/v2`.

> Дата создания: Июнь 2026
> Статус: исследовательский пайплайн; актуальное число тестов и evidence gates проверяются CI
