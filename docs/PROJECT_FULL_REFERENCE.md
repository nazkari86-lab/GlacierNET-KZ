...
> Конкурсы: Daryn → ISEF → GENIUS Olympiad
...
11. [Конкурсы и планы](#11-конкурсы-и-планы)
...
### 11.1. Конкурсный путь

```
Daryn (республиканский) → ISEF (международный) → GENIUS Olympiad
```

### 11.2. Фазы проекта (из MASTER_PLAN.md)
...
| 10 | Подготовка к конкурсам | 📋 Запланировано |

### 11.3. Рекомендации по дальнейшим шагам
