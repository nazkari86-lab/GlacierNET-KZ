...
Компактный `rgi_study_area.shp` с 586 объектами и обязательными sidecar-файлами
включён в репозиторий, чтобы реестр, Risk Twin и E2E-проверка работали после
обычного clone. Полный 155 MB региональный исходник остаётся локальным и
воспроизводится по ссылке и DOI выше.
